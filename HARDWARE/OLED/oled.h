...
//#define SCL PBout(8) //串行时钟
//#define SDA PBout(9) //串行数据
...
void OLED_P6x8Str(unsigned char x,unsigned char y,u8 ch[]);// -- 6x8点整，用于显示ASCII码的最小阵列，不太清晰
...
void OLED_P6x8Num(unsigned char x,unsigned char y,u16 num,int d);
#endif
